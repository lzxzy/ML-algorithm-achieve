...
if __name__ == '__main__':
    '''if len(sys.argv) != 4:
        ...
        exit(0)
    n = float(sys.argv[1])'''
    trainFile = open('/home/lz/workspace/ML algorithm achieve/Preceptron/train','r',0)
    modelFile = open('/home/lz/workspace/ML algorithm achieve/Preceptron/model','w',0)
    lens = 0
